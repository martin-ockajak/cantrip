...
use cantrip::{CollectionInto, Transform, List, Map, SequenceInto, Collection, TransformVec};

use crate::extensions::collection_into::test_collection_into;
...
use crate::extensions::sequence_into::test_sequence_into;
use crate::extensions::slice::test_slice;
use crate::extensions::collection::test_collection;
use crate::extensions::transform_into::test_transform_into;
...
use crate::extensions::transform_vec_into::test_transform_vec_into;
...
where
  ...
  <C as CollectionInto<i64>>::This<i64>: TestCollection<i64>,
  D: TestCollectible<'a, Vec<i64>>,
  D::This<i64>: TestCollection<i64>,
  G: TestCollectible<'a, (i64, i64)>,
{
  test_collection(false, a, b, e);
  test_collection_into(false, a, b, d, e);
  test_transform(false, a, e);
  test_transform_into(false, a, g, e);
  test_transform_vec(false, a, e);
  test_transform_vec_into(false, a.clone().into_iter(), e.clone().into_iter());
}
...
where
  ...
  D: TestCollectible<'a, Vec<i64>>,
  D::This<i64>: TestCollection<i64>,
  G: SequenceInto<(i64, i64)> + CollectionInto<(i64, i64)> + TestCollectible<'a, (i64, i64)>,
  <G as SequenceInto<(i64, i64)>>::This<i64>: TestCollection<i64>,
  for<'c> &'c C: UnwindSafe,
{
  test_collection(true, a, b, e);
  test_collection_into(true, a, b, d, e);
  test_sequence(a, b, e);
  test_sequence_into(a, b, c, g, e);
  test_transform_into(false, a, g, e);
  test_transform_vec_into(true, a.clone().into_iter(), e.clone().into_iter());
}
